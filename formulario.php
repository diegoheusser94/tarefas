<form method="POST">
	...
	<fieldset>
		...
		<label>
			Descrição (Opcional):
			<textarea name="descricao"><?php echo $tarefa['descricao']; ?>
			</textarea>
		</label>
		<label>
			Prazo (Opcional):
			...
			<?php endif; ?>
			<input type="text" name="prazo" value="<?php echo ($tarefa['id']>0)?traduz_data_para_exibir($tarefa['prazo']):$tarefa['prazo']; ?>" />
		</label>
		<fieldset>
